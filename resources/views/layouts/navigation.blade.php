        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs(['courses.index', 'dashboard'])">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                    <!-- ALTERED -->
                    @auth
                        <x-nav-link :href="route('favourites.index')" :active="request()->routeIs('favourites.*')">
                            {{ __('Favourites (Starred)') }}
                        </x-nav-link>
                        <x-nav-link :href="route('teachers.index')" :active="request()->routeIs('teachers.index')">
                            {{ __('Teachers') }}
                        </x-nav-link>
                        <x-nav-link :href="route('courses.my')" :active="request()->routeIs('courses.my', 'courses.mySort')">
                            {{ __('My Courses Page') }}
                        </x-nav-link>
                        @if(Auth::user()->isAdmin())
                            ...
                            <x-nav-link :href="route('facilities.create')" :active="request()->routeIs('facilities.*')">
